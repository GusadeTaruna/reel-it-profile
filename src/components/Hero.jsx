  ...
  return (
    <>
      <div className="h-screen bg-hero flex flex-col align-middle justify-center text-white text-center">
        ...
        <div className="p-4 m-auto mt-0">
          <h1 className="text-4xl md:text-7xl xl:text-9xl">REEL IT</h1>
          ...
          <h1 className="text-4xl md:text-7xl xl:text-9xl mb-12">STUDIOS</h1>
          <div className="flex justify-center">
            <button className="border rounded border-[#37373e] bg-[#0e0e10] transition duration-200 hover:bg-[#FFFFFF] hover:text-[#000000] w-[50%] p-[1.6em] mb-3 -rotate-3">
